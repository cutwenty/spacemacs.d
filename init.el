...
values."
  (setq-default
   ...
   ;; `+distribution'. For       (require 'org-octopress)
   ;; or `spacemacs'. (default 'spacemacs)
   dotspacemacs-distribution 'spacemacs
   ;; List of additional paths where to look for c
   ;; Paths must have a trailing slash (i.e. `~/.mycontribs/')
   dotspacemacs-configuration-layer-path '()
   ;; List of configuratio
   ;; of a list then all discovered layer)s will be insta)
...
values."
  ...
  (setq-default
   ...
   ;; (default nil)
   ;; 编程模式中 smartparens-strict-mode模式
...
you should place your code here."
  ...
  (setq yas/root-directory "~/.spacemacs.d/snippets")
